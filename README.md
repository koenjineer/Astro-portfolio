...
Webエンジニア・Hiroyuki Chumanのポートフォリオサイトです。
...
本リポジトリはモノレポ構成で、`apps/` 配下に4つのプロジェクトが入っています。
...
└── open-cafe-next/             # 制作実績のひとつ（Next.js + ヘッドレスWordPress）
```
...
| サイト名 | 種別 | 技術 |
|---|---|---|
| [OPEN CAFE](https://open-cafe-next.vercel.app) | カフェサイト（架空） | Next.js / TypeScript / Tailwind CSS / WordPress |
